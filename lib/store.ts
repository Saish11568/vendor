...
export const allProducts: Product[] = [
  {
    ...
    rating: 4.8,
    reviews: 2453,
    image: "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=400&h=400&fit=crop&q=60&auto=format",
    badge: "Best Seller",
    vendor: "Apple Store",
    category: "Laptops",
    inStock: true,
    ...
    images: [
      "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=800&h=800&fit=crop&q=60&auto=format",
      "https://images.unsplash.com/photo-1611186871348-b1ce696e52c9?w=800&h=800&fit=crop&q=60&auto=format",
      "https://images.unsplash.com/photo-1541807084-5c52b6b3adef?w=800&h=800&fit=crop&q=60&auto=format",
    ],
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 8921,
    image: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=400&h=400&fit=crop&q=60&auto=format",
    badge: "Top Rated",
    ...
    images: [
      "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=800&h=800&fit=crop&q=60&auto=format",
      "https://images.unsplash.com/photo-1583394838336-acd977736f90?w=800&h=800&fit=crop&q=60&auto=format",
    ],
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 3241,
    image: "https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?w=400&h=400&fit=crop&q=60&auto=format",
    ...
    images: [
      "https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?w=800&h=800&fit=crop&q=60&auto=format",
    ],
  ...
  },
  {
    ...
    rating: 4.6,
    reviews: 1892,
    image: "https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=400&h=400&fit=crop&q=60&auto=format",
    vendor: "Apple Store",
    category: "Watches",
    inStock: true,
    stock: 60,
    ...
    images: [
      "https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=800&h=800&fit=crop&q=60&auto=format",
    ],
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 892,
    image: "https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=400&h=400&fit=crop&q=60&auto=format",
    badge: "Pro Choice",
    vendor: "Canon Direct",
    category: "Cameras",
    inStock: true,
    ...
    images: [
      "https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=800&h=800&fit=crop&q=60&auto=format",
    ],
  ...
  },
  {
    ...
    rating: 4.5,
    reviews: 4521,
    image: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400&h=400&fit=crop&q=60&auto=format",
    vendor: "Nike Store",
    category: "Fashion",
    inStock: true,
    stock: 200,
    ...
    images: [
      "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=800&h=800&fit=crop&q=60&auto=format",
    ],
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 2109,
    image: "https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?w=400&h=400&fit=crop&q=60&auto=format",
    vendor: "Apple Store",
    category: "Electronics",
    inStock: true,
    stock: 55,
    ...
    images: [
      "https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?w=800&h=800&fit=crop&q=60&auto=format",
    ],
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 1567,
    image: "https://images.unsplash.com/photo-1558317374-067fb5f30001?w=400&h=400&fit=crop&q=60&auto=format",
    badge: "Trending",
    ...
    images: [
      "https://images.unsplash.com/photo-1558317374-067fb5f30001?w=800&h=800&fit=crop&q=60&auto=format",
    ],
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 3456,
    image: "https://images.unsplash.com/photo-1606220945770-b5b6c2c55bf1?w=400&h=400&fit=crop&q=60&auto=format",
    badge: "New",
    vendor: "Bose Store",
    category: "Audio",
    inStock: true,
    ...
    images: [
      "https://images.unsplash.com/photo-1606220945770-b5b6c2c55bf1?w=800&h=800&fit=crop&q=60&auto=format",
    ],
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 2876,
    image: "https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?w=400&h=400&fit=crop&q=60&auto=format",
    badge: "Best Value",
    ...
    images: [
      "https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?w=800&h=800&fit=crop&q=60&auto=format",
    ],
  ...
  },
  {
    ...
    rating: 4.6,
    reviews: 5432,
    image: "https://images.unsplash.com/photo-1556906781-9a412961c28c?w=400&h=400&fit=crop&q=60&auto=format",
    vendor: "Adidas Store",
    category: "Sports",
    inStock: true,
    stock: 150,
    ...
    images: [
      "https://images.unsplash.com/photo-1556906781-9a412961c28c?w=800&h=800&fit=crop&q=60&auto=format",
    ],
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 12453,
    image: "https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?w=400&h=400&fit=crop&q=60&auto=format",
    badge: "Hot",
    vendor: "Sony Official",
    category: "Electronics",
    inStock: true,
    ...
    images: [
      "https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?w=800&h=800&fit=crop&q=60&auto=format",
    ],
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 1245,
    image: "https://images.unsplash.com/photo-1593642632823-8f785ba67e45?w=400&h=400&fit=crop&q=60&auto=format",
    vendor: "Dell Store",
    category: "Laptops",
    inStock: true,
    stock: 30,
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 876,
    image: "https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?w=400&h=400&fit=crop&q=60&auto=format",
  ...
  },
  {
    ...
    price: 111999,
    originalPrice: 127999,
    rating: 4.6,
    reviews: 1102,
    image: "https://images.unsplash.com/photo-1544006659-f0b21f04cb1d?w=400&h=400&fit=crop&q=60&auto=format",
    badge: "Versatile",
    vendor: "HP Store",
    category: "Laptops",
    inStock: true,
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 2341,
    image: "https://images.unsplash.com/photo-1603302576837-37561b2e2302?w=400&h=400&fit=crop&q=60&auto=format",
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 1543,
    image: "https://images.unsplash.com/photo-1696446701796-da61225697cc?w=400&h=400&fit=crop&q=60&auto=format",
    vendor: "Google Store",
    category: "Electronics",
    inStock: true,
    stock: 100,
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 25431,
    image: "https://images.unsplash.com/photo-1578303512597-81e6cc155b3e?w=400&h=400&fit=crop&q=60&auto=format",
    badge: "Family Fun",
    vendor: "Nintendo",
    category: "Electronics",
    inStock: true,
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 45621,
    image: "https://images.unsplash.com/photo-1592492159418-39f319320569?w=400&h=400&fit=crop&q=60&auto=format",
    vendor: "Amazon Store",
    category: "Electronics",
    inStock: true,
    stock: 300,
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 876,
    image: "https://images.unsplash.com/photo-1560769629-975ec94e6a86?w=400&h=400&fit=crop&q=60&auto=format",
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 15642,
    image: "https://images.unsplash.com/photo-1603351154351-5e2d0600bb77?w=400&h=400&fit=crop&q=60&auto=format",
    badge: "Top Seller",
    vendor: "Apple Store",
    category: "Audio",
    inStock: true,
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 8976,
    image: "https://images.unsplash.com/photo-1608156639585-b3a032ef9689?w=400&h=400&fit=crop&q=60&auto=format",
    vendor: "JBL Official",
    category: "Audio",
    inStock: true,
    stock: 120,
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 1243,
    image: "https://images.unsplash.com/photo-1545454675-3531b543be5d?w=400&h=400&fit=crop&q=60&auto=format",
    vendor: "Sonos Store",
    category: "Audio",
    inStock: true,
    stock: 45,
  ...
  },
  {
    ...
    rating: 4.6,
    reviews: 18942,
    image: "https://images.unsplash.com/photo-1542272604-787c3835535d?w=400&h=400&fit=crop&q=60&auto=format",
    vendor: "Levi's Store",
    category: "Fashion",
    inStock: true,
    stock: 500,
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 5621,
    image: "https://images.unsplash.com/photo-1572635196237-14b3f281503f?w=400&h=400&fit=crop&q=60&auto=format",
    badge: "Iconic",
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 3241,
    image: "https://images.unsplash.com/photo-1551028719-00167b16eac5?w=400&h=400&fit=crop&q=60&auto=format",
    vendor: "TNF Store",
    category: "Fashion",
    inStock: true,
    stock: 80,
  ...
  },
  {
    ...
    rating: 4.5,
    reviews: 8921,
    image: "https://images.unsplash.com/photo-1517668808822-9ebb02f2a0e6?w=400&h=400&fit=crop&q=60&auto=format",
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 4532,
    image: "https://images.unsplash.com/photo-1550985543-56565ed12cbf?w=400&h=400&fit=crop&q=60&auto=format",
  ...
  },
  {
    ...
    rating: 4.6,
    reviews: 1543,
    image: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=400&h=400&fit=crop&q=60&auto=format",
    vendor: "Samsung Store",
    category: "Watches",
    inStock: true,
    stock: 90,
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 15432,
    image: "https://images.unsplash.com/photo-1519861531473-920036214751?w=400&h=400&fit=crop&q=60&auto=format",
    badge: "#1 Indoor Ball",
    vendor: "Wilson Store",
    category: "Sports",
    inStock: true,
  ...
  },
  {
    ...
    rating: 4.6,
    reviews: 876,
    image: "https://images.unsplash.com/photo-1544117518-30dd05999bbd?w=400&h=400&fit=crop&q=60&auto=format",
    vendor: "Therabody",
    category: "Sports",
    inStock: true,
    stock: 55,
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 3214,
    image: "https://images.unsplash.com/photo-1592419044706-39796d40f98c?w=400&h=400&fit=crop&q=60&auto=format",
    vendor: "ZenSport",
    category: "Sports",
    inStock: true,
    stock: 200,
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 8965,
    image: "https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?w=400&h=400&fit=crop&q=60&auto=format",
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 15432,
    image: "https://images.unsplash.com/photo-1594385208934-2c56d195bc5f?w=400&h=400&fit=crop&q=60&auto=format",
    badge: "Kitchen Icon",
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 45321,
    image: "https://images.unsplash.com/photo-1602143393494-721d0026210b?w=400&h=400&fit=crop&q=60&auto=format",
...
// ============ VENDOR PRODUCT CONVERTER ============

// Converts a vendor DB product to the customer Product format
export function vendorToProduct(vp: any): Product {
  return {
    id: vp.id,
    name: vp.name,
    price: vp.price,
    rating: 4.5,
    reviews: 0,
    image: vp.image || "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=400&h=400&fit=crop&q=60&auto=format",
    badge: vp.status === "active" ? "New" : undefined,
    vendor: "Vendor Store",
    category: vp.category || "General",
    inStock: vp.stock > 0,
    stock: vp.stock || 0,
    description: vp.name + " - Available from our vendor marketplace.",
  }
}
...
export interface StoreState {
  ...
  // Products (vendor + static)
  vendorProducts: Product[]
  getAllProducts: () => Product[]
  refreshVendorProducts: () => void
