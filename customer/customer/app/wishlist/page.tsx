        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-6">
            <div>
              ...
              <p className="text-xl font-bold text-foreground">${totalValue.toLocaleString(undefined, {minimumFractionDigits: 2})}</p>
            </div>
              ...
              <div className="p-4 -mt-6">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    {item.originalPrice && (
                      <span className="text-sm text-muted-foreground line-through ml-2">${item.originalPrice.toFixed(2)}</span>
                    )}
                  </div>
                  <Button
                    size="sm"
