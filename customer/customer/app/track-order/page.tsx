        ...
        <div className="bg-card rounded-xl border border-border p-6 mb-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 pb-6 border-b border-border">
            ...
            <div>
              ...
              <p className="font-bold text-foreground">${trackedOrder.total.toFixed(2)}</p>
            </div>
          </div>
            ...
            {trackingSteps.map((step, index) => {
              ...
              return (
                <div key={step.status} className="relative pb-8 last:pb-0">
                  ...
                  {/* Content */}
                  <div className={`${isCurrent ? "bg-primary/5 -m-3 p-3 rounded-lg border border-primary/20" : ""}`}>
            ...
            {orders.slice(0, 5).map((order) => (
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <p className="text-sm font-medium text-foreground mt-1">${order.total.toFixed(2)}</p>
                </div>
              </button>
            ))}
          </div>
